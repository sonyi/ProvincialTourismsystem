...
public class Map_BNavigatorActivity extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        //创建导航视图  
        View navigatorView = BNavigator.getInstance().init(Map_BNavigatorActivity.this, getIntent().getExtras(), nMapView);  
